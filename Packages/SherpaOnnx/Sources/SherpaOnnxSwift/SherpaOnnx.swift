...
public class SherpaOnnxOfflineRecongitionResult {
  ...
  private lazy var _tokens: [String] = {
    guard let tokensPointer = result.pointee.tokens_arr else { return [] }
    return (0..<result.pointee.count).compactMap { index -> String? in
      guard let ptr = tokensPointer[Int(index)] else { return nil }
      return String(cString: ptr)
    }
  }()
...
final class SherpaOnnxGenerationConfigC {
  ...
  public init(_ swiftConfig: SherpaOnnxGenerationConfigSwift) {
